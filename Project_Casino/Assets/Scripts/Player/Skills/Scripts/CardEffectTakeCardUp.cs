...
[CreateAssetMenu(menuName = "Cards/Effects/TakeCardUp", fileName = "FX_TakeCardUp_")]
public class CardEffectTakeCardUp : CardEffect
{
    ...
    [SerializeField] private Sprite cardThree;
